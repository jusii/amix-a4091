...
## Concrete fixes / additions for `~/Devel/Omat/Amiga/Amix/A4091/src/a4091.c`
...
7. **Reference files you'll actually need next** (not siop2.c): the 710 logic is in `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/siop.c` (NetBSD 710 driver, `siopreset`/`siop_start`/`siopintr`), `siop_script.ss` (the 710 SCRIPTS, not siop2_script.ss), and `ncr7xx.c` (`get_ncrreg*`/`set_ncrreg*` are your portable access-primitive template). Board offsets: register file at board+`A4091_OFFSET_REGISTERS`=0x00800000 (`a4091.h:19`), confirming your `SIOP_OFF`.
...
**Commands** (run from `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software`):
```
...
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/Makefile`
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/README.md`
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/romtool.c`
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/a4091d.c`
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/bootmenu.c`
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/battmem.c` and `battmem.h`
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/attach.c` (DIP/host-id readers ~393-477; switch write ~359)
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/device.c` (mount_drives 407-447)
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/scsiconf.c` (scsi_probe_bus 380/449/481)
- `~/Devel/Omat/Amiga/Amix/A4091/reference/a4091-software/a4091.h` (HW offsets 17-21)
